  ...
  (function (e, t) {
    ...
    const We = {
      ...
      findElements() {
        try {
          return (
            ...
            (this.elements.display = { buffer: he.call(this, this.config.selectors.display.buffer), currentTime: he.call(this, this.config.selectors.display.currentTime), duration: he.call(this, this.config.selectors.display.duration) }),
      ...
      inject() {
        ...
        j(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)),
          ...
          H(this.config.controls) || _(this.config.controls) ? (e = this.config.controls) : ((e = We.create.call(this, { id: this.id, seektime: this.config.seekTime, speed: this.speed, quality: this.quality, captions: Ye.getLabel.call(this) })), (i = !1))
        let s
        i &&
    ...
    const ht = {
      ...
      ready() {
        ...
        if (
          (u.setAttribute('src', d), u.setAttribute('allowfullscreen', ''), u.setAttribute('allow', ['autoplay', 'fullscreen', 'picture-in-picture', 'encrypted-media', 'accelerometer', 'gyroscope'].join('; ')), W(s) || u.setAttribute('referrerPolicy', s), i || !t.customControls)
        )
        ...
        setup() {
          this.media
            ? (le(this.elements.container, this.config.classNames.type.replace('{0}', this.type), !0),
              ...
              this.isVideo && ((this.elements.wrapper = Z('div', { class: this.config.classNames.video })), J(this.media, this.elements.wrapper), (this.elements.poster = Z('div', { class: this.config.classNames.poster })), this.elements.wrapper.appendChild(this.elements.poster)),
              ...
              ;(document.body.style.overflow = ''),
                ...
                t
                  ? (Object.keys(this.elements).length &&
                      (te(this.elements.buttons.play), te(this.elements.captions), te(this.elements.controls), te(this.elements.wrapper), (this.elements.buttons.play = null), (this.elements.captions = null), (this.elements.controls = null), (this.elements.wrapper = null)),
                    j(e) && e())
                  : (we.call(this),
                    Le.cancelRequests.call(this),
